const projects = {
  'yuhuashi-info': {
    page: '07', title: '金陵雨花石录 · 信息图谱', year: '2026', typeZh: '信息可视化', typeEn: 'INFOGRAPHIC DESIGN', cover: 'assets/covers/yuhuashi-info.jpg', pages: ['assets/works/yuhuashi-info/01.jpg','assets/works/yuhuashi-info/02.jpg','assets/works/yuhuashi-info/03.jpg','assets/works/yuhuashi-info/04.jpg'],
  ...
  'yuhuashi-installation': {
    page: '08', title: '金陵雨花石录 · 交互装置', year: '2026', typeZh: '交互装置', typeEn: 'INTERACTIVE INSTALLATION', cover: 'assets/covers/yuhuashi-installation.jpg', pages: ['assets/works/yuhuashi-installation/01.jpg','assets/works/yuhuashi-installation/02.jpg','assets/works/yuhuashi-installation/03.jpg','assets/works/yuhuashi-installation/04.jpg'], video: 'assets/videos/yuhuashi-installation.mp4',
  ...
  nature: {
    page: '09', title: '自然色差', year: '2026', typeZh: '数据可视化', typeEn: 'DATA VISUALIZATION', cover: 'assets/covers/nature.jpg', pages: ['assets/works/nature/01.jpg','assets/works/nature/02.jpg','assets/works/nature/03.jpg','assets/works/nature/04.jpg','assets/works/nature/05.jpg','assets/works/nature/06.jpg'], video: 'assets/videos/nature-web.webm', videoType: 'video/webm',
  ...
  tongqu: {
    page: '10', title: '瞳趣', year: '2026', typeZh: '产品体验设计', typeEn: 'UX / UI DESIGN', cover: 'assets/covers/tongqu.jpg', pages: ['assets/works/tongqu/01.jpg','assets/works/tongqu/02.jpg','assets/works/tongqu/03.jpg','assets/works/tongqu/04.jpg','assets/works/tongqu/05.jpg'], video: 'assets/videos/tongqu-web.webm', videoType: 'video/webm',
  ...
  coffee: {
    page: '11', title: '上海牌咖啡', year: '2025', typeZh: '品牌视觉', typeEn: 'VISUAL IDENTITY', cover: 'assets/covers/coffee.jpg', pages: ['assets/works/coffee/01.jpg','assets/works/coffee/02.jpg','assets/works/coffee/03.jpg','assets/works/coffee/04.jpg','assets/works/coffee/05.jpg'],
  ...
  tangsancai: {
    page: '12', title: '唐三彩 · 文旅网页设计', year: '2026', typeZh: '网页设计', typeEn: 'WEB DESIGN', cover: 'assets/covers/tangsancai.jpg', pages: ['assets/works/tangsancai/01.jpg','assets/works/tangsancai/02.jpg','assets/works/tangsancai/03.jpg'],
  ...
  space: {
    page: '13', title: '魔方筑境', year: '2025', typeZh: '空间设计', typeEn: 'SPATIAL DESIGN', cover: 'assets/covers/space.jpg', pages: ['assets/works/space/01.jpg','assets/works/space/02.jpg'],
  ...
  dopamine: {
    page: '14', title: '不打不打 · 多巴胺行动', year: '2024', typeZh: '视觉传播', typeEn: 'POSTER / CAMPAIGN', cover: 'assets/covers/dopamine.jpg', pages: ['assets/works/dopamine/01.jpg','assets/works/dopamine/02.jpg'],
  ...
  appetite: {
    page: '15', title: '食欲补丁', year: '2024', typeZh: '概念视觉', typeEn: 'VISUAL CONCEPT', cover: 'assets/covers/appetite.jpg', pages: ['assets/works/appetite/01.jpg','assets/works/appetite/02.jpg'],
  ...
  cpus: {
    page: '16', title: 'CPUS', year: '2025', typeZh: '文化海报', typeEn: 'CULTURAL POSTER', cover: 'assets/covers/cpus.jpg', pages: ['assets/works/cpus/01.jpg','assets/works/cpus/02.jpg'],
...
pageStack.innerHTML = project.pages.map((page, index) => (
  `<figure class="page-board"><img src="${asset(page)}" alt="${project.title}项目展板 ${index + 1}" ${index < 2 ? 'loading="eager"' : 'loading="lazy"'}></figure>`
)).join('') + (project.video ? (
  `<figure class="page-board page-video"><video controls playsinline preload="metadata" poster="${project.cover}" aria-label="${project.title}项目视频"><source src="${project.video}" type="${project.videoType || 'video/mp4'}">${project.videoFallback ? `<source src="${project.videoFallback}" type="video/mp4">` : ''}当前浏览器不支持视频播放。</video><figcaption>项目影像 / PROJECT FILM</figcaption></figure>`
) : '');
